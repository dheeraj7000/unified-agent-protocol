...
vectors = {
    ...
    "03_missing_actor.json": {
        ...
        "expect": {"status": "failed", "error.code": "INVALID_ENVELOPE"},
    },
    "04_missing_intent_goal.json": {
        ...
        "expect": {"status": "failed", "error.code": "INVALID_INTENT"},
    },
    "05_actor_no_agent_id.json": {
        ...
        "expect": {"status": "failed", "error.code": "INVALID_ACTOR"},
    },
    "06_tool_denied.json": {
        "name": "06_tool_denied",
        ...
        "input": {
            ...
            "intent": {"goal": "list overdue invoices"},
            "policy": {"denied_tools": ["invoice.list_overdue"]},
        },
        "expect": {"status": "failed", "error.code": "TOOL_DENIED"},
    },
    "07_tool_not_allowed.json": {
        ...
        "expect": {"status": "failed", "error.code": "TOOL_NOT_ALLOWED"},
    },
    "08_risk_too_high.json": {
        ...
        "expect": {"status": "failed", "error.code": "RISK_EXCEEDS_POLICY"},
    },
    "09_approval_required.json": {
        ...
        "input": {
            ...
            "intent": {"goal": "list overdue invoices"},
            "policy": {"requires_approval": ["invoice.list_overdue"]},
        },
        "expect": {"status": "waiting_for_approval", "error.code": "APPROVAL_REQUIRED"},
    },
    "10_dag_chain.json": {
        "name": "10_dag_chain",
    ...
    "11_field_masking.json": {
        ...
        "input": {
            ...
            "intent": {"goal": "list overdue invoices"},
            "context_request": {"fields": ["invoice_id"]},
        },
        "expect": {"status": "completed"},
    },
    ...
    "13_unsupported_version.json": {
        ...
        "expect": {"status": "failed", "error.code": "UNSUPPORTED_VERSION"},
    },
    "14_empty_graph.json": {
        "name": "14_empty_graph",
